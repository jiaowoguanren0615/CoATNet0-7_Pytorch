...
from util import *
from model import coatnet_0, coatnet_1, coatnet_2, coatnet_3, coatnet_4, coatnet_5, coatnet_6, coatnet_7
from estimate_model import Predictor, Plot_ROC, predict_single_image


def get_args_parser():
    parser = argparse.ArgumentParser(
        'CoAtNet training and evaluation script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='coatnet_4', type=str, metavar='MODEL',
